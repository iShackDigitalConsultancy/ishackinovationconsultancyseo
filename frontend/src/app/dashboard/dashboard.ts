      ...
      <div class="w-64 bg-slate-900 text-slate-300 flex flex-col transition-all duration-300 relative z-20 shadow-2xl">
        ...
        <div class="flex-1 overflow-y-auto py-4">
          <nav class="space-y-1 px-3">
            ...
            <a routerLink="/blog" class="text-slate-400 group flex items-center px-3 py-2.5 text-sm font-medium rounded-xl hover:text-white hover:bg-slate-800 transition-colors mt-2">
              <svg class="text-slate-500 mr-3 flex-shrink-0 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z"></path></svg>
              AEO News & Views
            </a>
          </nav>
        </div>
