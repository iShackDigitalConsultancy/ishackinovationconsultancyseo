    ...
    <div class="min-h-screen bg-slate-50 font-sans text-slate-800 flex flex-col pt-12 pb-24">
      ...
      <div class="max-w-xl mx-auto w-full px-4">
        ...
        <div *ngIf="currentStep === 1" class="bg-white rounded-3xl shadow-xl shadow-slate-200/50 p-8 border border-slate-100 mt-12 animate-fade-in text-center">
          <div class="mb-8">
             <svg viewBox="0 0 92 30" class="h-12 mx-auto" xmlns="http://www.w3.org/2000/svg">
                <path fill="#4285f4" d="M29.8 13.7c0 5-4.2 9.2-9.4 9.2-5.4 0-9.6-4.2-9.6-9.4 0-5.1 4.2-9.4 9.6-9.4 5.3 0 9.4 4.1 9.4 9.6zm-15.6.8c0 3 2.3 5.4 5.8 5.4 3.7 0 6-2.4 6-5.6 0-3.1-2.4-5.6-6-5.6-3.6.2-5.8 2.6-5.8 5.8z" />
                <path fill="#ea4335" d="M49 13.9c0 5.1-4.1 9.4-9.4 9.4-5.4 0-9.6-4.2-9.6-9.4 0-5.3 4.2-9.6 9.6-9.6 5.3 0 9.4 4.3 9.4 9.6zm-15.5.6c0 3 2.3 5.3 5.8 5.3 3.5 0 5.9-2.3 5.9-5.4 0-3-2.3-5.3-5.9-5.3-3.6.1-5.8 2.4-5.8 5.4z" />
                <path fill="#fbbc05" d="M68.3 13.9c0 5.1-4.2 9.4-9.6 9.4-5.4 0-9.6-4.2-9.6-9.4 0-5.3 4.2-9.6 9.6-9.6 5.3 0 9.6 4.3 9.6 9.6zm-15.5.6c0 3 2.3 5.3 5.8 5.3 3.5 0 5.9-2.3 5.9-5.4 0-3-2.3-5.3-5.9-5.3-3.5.1-5.8 2.4-5.8 5.4z" />
                <path fill="#4285f4" d="M87.5 9.1v13.6c0 5.4-3.4 7.6-7.3 7.6-3.8 0-6.1-2.5-7-4.6l3.2-1.3c.5 1.2 1.9 2.5 4 2.5 2.6 0 4.1-1.6 4.1-4.5v-1h-.2c-1.1 1.4-3.1 2.3-5.3 2.3-5 0-9.2-4.1-9.2-9.2 0-5.4 4.2-9.4 9.2-9.4 2.3 0 4.2 1 5.2 2.3h.1v-1.7h3.3v3.4zm-11.9 5.3c0 2.9 2.1 5.3 5.2 5.3 3 0 5.1-2.4 5.1-5.3 0-2.8-2.1-5.2-5.1-5.2-3.1.2-5.2 2.5-5.2 5.2z" />
                <path fill="#34a853" d="M91.8 1.4v21h-3.4v-21h3.4z" />
                <path fill="#ea4335" d="M107.1 18.2l2.7 1.8c-1.1 1.8-3.4 3.4-6.6 3.4-5.3 0-9.2-4.1-9.2-9.2 0-5.1 3.9-9.2 8.8-9.2 4.9 0 7.5 4.1 8.4 6.3l.4 1.1-12 4.9c1 2 2.6 3.2 4.6 3.2 2.2 0 3.8-1 4.9-2.3zm-11.4-4l8.3-3.4c-.4-1.1-1.7-1.9-3.2-1.9-2 0-4.6 1.7-5.1 5.3z" />
                <path fill="#4285f4" d="M14.6 22.8l-2.6-2.6h-.1c-1.8 2.2-4.7 3.2-7.6 3.2C4.1 23.4 0 19.3 0 14V0h3.5v13.6c0 4.1 2.5 6.4 5.8 6.4 3 0 5.3-2.5 5.3-6.1V0h3.5v22.8h-3.5z"/>
             </svg>
          </div>
          ...
          <div class="bg-white border border-slate-200 rounded-3xl p-4 space-y-3 mb-24 shadow-sm">
             <div *ngFor="let art of articles; let i = index" class="border border-slate-100 text-slate-800 px-4 py-3.5 rounded-2xl flex items-center justify-between gap-4 w-full shadow-[0_2px_10px_rgba(0,0,0,0.02)]">
               <div class="flex items-center gap-3">
                 ...
                 <span class="font-bold text-[14px] leading-snug">{{ art }}</span>
               </div>
               <div class="flex items-center gap-1 shrink-0">
                 <button class="p-2 text-slate-400 hover:text-slate-600 hover:bg-slate-50 rounded-full transition-colors border border-transparent hover:border-slate-200">
